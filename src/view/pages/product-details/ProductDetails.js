            ...
            <div className='pro_detail-content'>
                <div className='pro_detail-image'>
                    ...
                    <div className='pro_detail-img_list'>
                        <img src = {img1} alt = 'anh ao'  className='pro_detail-img-item' onMouseOver={()=>setPicture(img1)}/>
                        <img src = {img2} alt = 'anh ao' className='pro_detail-img-item' onMouseOver={()=>setPicture(img2)}/>
                        <img src = {img3} alt = 'anh ao' className='pro_detail-img-item' onMouseOver={()=>setPicture(img3)}/>
                        <img src = {img4} alt = 'anh ao' className='pro_detail-img-item' onMouseOver={()=>setPicture(img4)}/>
                        <img src = {img2} alt = 'anh ao' className='pro_detail-img-item' onMouseOver={()=>setPicture(img2)}/>
                    </div>
                ...
                Áo sơ mi nữ form rộng tay dài kiểu hàn, áo sơ mi nữ nam trắng 1 túi basic điệu đà
                    </h3>
                    ...
                    <div className='pro_detail-price'>
                        <div className='pro_detail-price_detail'>
                            ...
                            <span className='pro_detail-realprice'>
                                <sup style={{textDecoration : 'underline'}}>đ</sup>59.000</span> 
            ...
            <div className='pro_detail-description'>
                <div className='pro_detail-wrap-left'>
                    ...
                    <div className='pro_detail-para'>
                        <p>
                    áo sơ mi nữ form rộng tay dài kiểu hàn, áo sơ mi nữ trắng 1 túi basic điệu đà<br/><br/>
                    màu sắc:trắng, đen<br/><br/>
                    Free size <br/><br/>
                    áo thiết kế màu trắng ạ mắt<br/><br/>
                    các b nhanh tay mua nhé <br/><br/>
                    áo phù hợp đi chơi đi làm <br/><br/>
                    rất dễ mix đồ ạ  có thể mix với chân váy quần short quần jean <br/><br/>
                    tất cả sản phẩm shop đều còn hàng và có sẵn sll <br/><br/>
                    shop liên tục tuyển sỉ và ctv toàn quốc <br/><br/>
                        </p>
