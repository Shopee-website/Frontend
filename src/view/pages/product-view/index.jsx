              ...
              <div className="pro_detail-image">
                ...
                <div className="pro_detail-img_list">
                  <img
                    ...
                    onMouseOver={() => setPicture(product.images[1])}
                  />
                  <img
                    src={product.images[2]}
                    alt="anh ao"
                    className="pro_detail-img-item"
                    onMouseOver={() => setPicture(product.images[2])}
                  />
                  <img
                    src={product.images[2]}
                    alt="anh ao"
              ...
              <div className="pro_detail-body">
                ...
                <div className="pro_detail-price">
                  <div className="pro_detail-price_detail">
                    ...
                    <span className="pro_detail-sale">
                      {product.promotionPercent}% giảm
                    </span>
                  </div>
                ...
                <table className="pro_detail-table">
                  ...
                  <tr className="pro_detail-column">
                    ...
                    <td className="pro_detail-column-btn">
                      <button
                        className={
                          active === "1" ? "pro_detail-active" : undefined
                        }
                        id={"1"}
                        key={1}
                        onClick={handleClick}
                      ...
                      <button
                        className={
                          active === "2" ? "pro_detail-active" : undefined
                        }
                        id={"2"}
                        key={2}
                        onClick={handleClick}
                      ...
                      <button
                        className={
                          active === "3" ? "pro_detail-active" : undefined
                        }
                        id={"3"}
                        key={3}
                        onClick={handleClick}
                      ...
                      <button
                        className={
                          active === "4" ? "pro_detail-active" : undefined
                        }
                        id={"4"}
                        key={4}
                        onClick={handleClick}
                  ...
                  <tr className="pro_detail-column">
                    ...
                    <td className="pro_detail-column-btn">
                      <button
                        ...
                        className={
                          active1 === "1" ? "pro_detail-active" : undefined
                        }
                      >
                        freesize
                      </button>
